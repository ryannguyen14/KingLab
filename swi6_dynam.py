...
class Particle(sphere): 
	...
	# 	sigma = self.radius #optimal distance
	...
	# 		# print("Forces: ", force_sum_x, force_sum_y, force_sum_z)
	# 	return force_sum_x, force_sum_y, force_sum_z, force_total
...
class Fuse(compound):
	...
	def calculateEnergy(self, particle_array):
		...
		oligomer_pair_list = []
		#print("Sigma: ", sigma)
		#print("Distance_array: ", distance_array_r)
		#print("Particle num array: ", particle_num_array)
		#print(particle_array)
		for j in range(0, len(distance_array_r)):
			#print("Distance_array_value: ", distance_array_r[j] <= sigma)
		...
		for pair in oligomer_pair_list:
			...
			#print(particle_array)
		#print("Oligomer pair list: ",oligomer_pair_list)
		#print("Test")
		#for j in range(0,len(distance_array_r)): 
			
			#for k in range(j+1, len(distance_array_r)):
			#	if distance_array_r[j] - distance_array_r[k] <= sigma and j !=k:
			#		oligomer_pair_list.append((j,k))
			#		print(oligomer_pair_list)
		# if len(oligomer_pair_list) != 0:
		# 	for pair in oligomer_pair_list:
		# 		temp_oligomer = Oligomer([particle_array[pair[0]],particle_array[pair[1]]])
		# 		particle_array.append(temp_oligomer)
		# 		particle_array[pair[0]].visible = False
		# 		particle_array[pair[1]].visible = False
		# 		print(pair[0])
		# 	#particle_array.pop([pair[0]])
		# 	#particle_array.pop([pair[1]])
		# print(particle_array)
